...
A simple command-line application for managing students, courses, enrollments, and grades.
...
### 1. Clone the project
```bash
git clone https://github.com/altinaabaziii/Homework2.git
cd Homework2
```
...
```bash
python main.py add-student --name "Altina"
...
- No database
- No UI
- Seed duplicates data if run multiple times