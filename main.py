...
def main():
    ...
    # enroll
    parse_enroll = subparsers.add_parser("enroll")
    parse_enroll.add_argument("--student-id", type=int,required=True)
    parse_enroll.add_argument("--course",required=True)
